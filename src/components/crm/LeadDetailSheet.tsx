    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full sm:max-w-xl bg-card border-border overflow-y-auto p-0">
        ...
        <div className="sticky top-0 z-10 bg-card border-b border-border px-6 py-5">
          ...
          {/* WhatsApp Button */}
          <div className="mt-4">
            <Button size="sm" className="w-full gap-2.5 rounded-xl h-10 bg-[#25D366] hover:bg-[#25D366]/90 text-white font-medium">
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-4 gap-2">
            <div className="text-center p-3 rounded-xl bg-primary/5 border border-primary/10">
              <p className="text-xl font-bold text-primary">{lead.probability}%</p>
              <p className="text-[10px] text-muted-foreground font-medium mt-0.5">Probabilidade</p>
            </div>
            <div className="text-center p-3 rounded-xl bg-success/5 border border-success/10">
              ...
              <p className="text-[10px] text-muted-foreground font-medium mt-0.5">Valor Est.</p>
            </div>
            <div className="text-center p-3 rounded-xl bg-warning/5 border border-warning/10">
              <p className="text-xl font-bold text-warning">{lead.totalMessages}</p>
              <p className="text-[10px] text-muted-foreground font-medium mt-0.5">Mensagens</p>
            </div>
            <div className="text-center p-3 rounded-xl bg-secondary/50">
              <p className="text-xl font-bold text-foreground">{lead.responseTime}m</p>
              <p className="text-[10px] text-muted-foreground font-medium mt-0.5">Tempo Resp.</p>
            </div>
          </div>
